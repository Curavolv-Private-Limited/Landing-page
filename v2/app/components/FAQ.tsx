  ...
  return (
    <section className="overflow-hidden">
      ...
      <div className="py-4 px-8 lg:px-16" style={{ borderBottom: '1px solid rgba(0,0,0,0.07)' }}>
        <p className="text-[10px] tracking-[0.32em] uppercase font-medium" style={{ color: '#444444' }}>Common Questions</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16 py-14 lg:py-20">
        ...
        <div className="grid lg:grid-cols-[1fr_1.6fr] gap-10 lg:gap-16 items-start">
          ...
          <AnimatedSection>
            ...
            <div className="w-8 h-px" style={{ backgroundColor: '#555555' }} />
          </AnimatedSection>
                ...
                >
                  <Accordion.Header>
                    <Accordion.Trigger className="w-full flex items-start justify-between gap-8 py-7 text-left cursor-pointer">
                      <span
                        ...
                        className="group-data-[state=open]:text-[#555555] transition-colors duration-200 pr-4"
                      >
                        {faq.q}
                      </span>
                      <span className="flex-shrink-0 w-6 h-6 flex items-center justify-center mt-0.5">
                        <span className="relative w-3 h-3">
                          <span className="absolute inset-y-1/2 left-0 right-0 h-px bg-[#555555]/35 group-data-[state=open]:bg-[#555555] transition-colors duration-200" />
                          <span className="absolute inset-x-1/2 top-0 bottom-0 w-px bg-[#555555]/35 group-data-[state=open]:scale-y-0 group-data-[state=open]:opacity-0 transition-all duration-200" />
                        </span>
                      </span>
                    </Accordion.Trigger>
                  </Accordion.Header>
                  <Accordion.Content className="overflow-hidden data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:slide-out-to-top-2 data-[state=open]:slide-in-from-top-2">
                    <div className="pb-8 pt-0">
                      <div className="w-4 h-px mb-5" style={{ backgroundColor: '#555555' }} />
