...
function StackCard({ item }: { item: typeof audiences[0] }) {
  return (
    ...
    >
      <div className="relative h-56 lg:h-auto overflow-hidden bg-[#F5F5F5]">
      ...
      <div className="max-w-7xl mx-auto px-8 lg:px-16 pt-10 lg:pt-14 pb-6 lg:pb-8">
        <AnimatedSection>
          <motion.p
            ...
            className="text-[10px] tracking-[0.32em] uppercase font-medium mb-3" style={{ color: '#555555' }}
          >
            Who We Serve
          </motion.p>
      ...
      <div ref={containerRef} style={{ height: '300vh' }}>
        <div style={{ position: 'sticky', top: 0, height: '100vh', overflow: 'hidden', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          ...
          <div style={{ position: 'absolute', bottom: '2.5rem', right: '2.5rem', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '0.5rem' }}>
            {/* Dot 1 — always active */}
            <div style={{ width: 6, height: 6, borderRadius: '50%', background: '#555555' }} />
            {/* Dot 2 — fills as card 2 arrives */}
            <div style={{ position: 'relative', width: 6, height: 6 }}>
              <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'rgba(17,20,17,0.15)' }} />
              <motion.div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: '#666666', scale: dot2Fill, opacity: dot2Fill }} />
            </div>
            {/* Dot 3 — fills as card 3 arrives */}
            <div style={{ position: 'relative', width: 6, height: 6 }}>
              <div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: 'rgba(17,20,17,0.15)' }} />
              <motion.div style={{ position: 'absolute', inset: 0, borderRadius: '50%', background: '#888888', scale: dot3Fill, opacity: dot3Fill }} />
            </div>
          </div>
