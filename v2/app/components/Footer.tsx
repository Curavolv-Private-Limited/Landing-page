...
export function Footer() {
  return (
    <footer style={{ backgroundColor: '#F5F5F5', borderTop: '1px solid rgba(0,0,0,0.07)' }}>

      {/* Gradient top rule */}
      <div className="h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(100,100,100,0.18), rgba(100,100,100,0.12), transparent)' }} />
        ...
        <div className="grid md:grid-cols-12 gap-10 mb-16">
          ...
          <motion.div {...fadeUp(0)} className="md:col-span-5">
            <div className="flex items-center gap-2.5 mb-6">
              <img src="/images/logo1.jpg" alt="Logo" className="h-8 w-auto" />
            </div>
