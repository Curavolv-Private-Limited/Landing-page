        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <AnimatedSection>
            <div className="flex items-start gap-4 mb-5">
              <div className="w-px h-16 flex-shrink-0 mt-0.5" style={{ background: 'linear-gradient(to bottom, #555555, rgba(100,100,100,0.15))' }} />
              <div>
                <p className="text-[10px] tracking-[0.32em] uppercase font-medium leading-tight" style={{ color: '#555555' }}>
                  The Curavolv Method
                </p>
          ...
          >
            <div className="absolute -top-5 -left-5 w-10 h-10 border-t border-l" style={{ borderColor: 'rgba(100,100,100,0.35)' }} />
            <div className="absolute -bottom-5 -right-5 w-10 h-10 border-b border-r" style={{ borderColor: 'rgba(100,100,100,0.35)' }} />
            <div
              className="relative overflow-hidden rounded-lg"
              style={{ boxShadow: '0 4px 24px rgba(0,0,0,0.10), 0 24px 80px rgba(100,100,100,0.08)' }}
            >
              <video
                ref={videoRef}
                muted
                playsInline
                controls
                className="w-full aspect-video bg-[#F5F5F5] block"
