    ...
    <div className="min-h-screen antialiased relative" style={{ backgroundColor: '#FFFFFF' }}>
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden" style={{ zIndex: 0 }} aria-hidden>
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(60,200,194,0.07) 0%, transparent 62%)',
        }} />
        {/* Upper-left violet bloom */}
        <div style={{
          position: 'absolute', top: '5%', left: '-5%',
          width: 700, height: 700, borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(147,112,219,0.06) 0%, transparent 60%)',
        }} />
        {/* Mid mint */}
        <div style={{
          position: 'absolute', top: '25%', right: '5%',
          width: 600, height: 600, borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(102,205,170,0.07) 0%, transparent 60%)',
        }} />
        {/* Mid-left violet */}
        <div style={{
          position: 'absolute', top: '42%', left: '-3%',
          width: 650, height: 650, borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(147,112,219,0.05) 0%, transparent 58%)',
        }} />
        {/* Center-right teal */}
        <div style={{
          position: 'absolute', top: '58%', right: '12%',
          width: 550, height: 550, borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(60,200,194,0.05) 0%, transparent 55%)',
        }} />
        {/* Lower-left mint */}
        <div style={{
          position: 'absolute', top: '72%', left: '8%',
          width: 500, height: 500, borderRadius: '50%',
          background: 'radial-gradient(circle, rgba(102,205,170,0.05) 0%, transparent 55%)',
        }} />
        {/* Bottom-right violet */}
        <div style={{
        ...
        <div style={{
          ...
          background: 'radial-gradient(circle, rgba(60,200,194,0.04) 0%, transparent 55%)',
        }} />
      </div>
