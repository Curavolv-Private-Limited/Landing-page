  ...
  return (
    <section id="our-approach" className="relative min-h-[70vh] flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0" style={{ background: 'linear-gradient(135deg, rgba(248,255,254,0.94) 0%, rgba(244,250,248,0.85) 50%, rgba(248,255,254,0.92) 100%)' }} />
        {/* Teal glow left */}
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 50% 60% at 15% 50%, rgba(60,200,194,0.10) 0%, transparent 60%)' }} />
        {/* Violet glow right */}
        <div className="absolute inset-0" style={{ background: 'radial-gradient(ellipse 50% 60% at 85% 50%, rgba(147,112,219,0.08) 0%, transparent 60%)' }} />
      </div>

      <div className="absolute top-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(60,200,194,0.25), transparent)' }} />
      <div className="absolute bottom-0 left-0 right-0 h-px" style={{ background: 'linear-gradient(to right, transparent, rgba(147,112,219,0.18), transparent)' }} />
        ...
        <div className="grid lg:grid-cols-12 gap-10 lg:gap-20 items-center">
          ...
          <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <h2 style={{ ...serif, fontSize: 'clamp(2.5rem, 4.5vw, 4rem)', color: '#111411' }} className="mb-0 leading-[1.08]">
              ...
              <br />
              <em style={{ ...serifItalic, color: '#3CC8C2' }}>They're Designed.</em>
            </h2>
          </motion.div>
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}
            ...
            <div className="mt-10 pl-7">
              <p className="font-medium text-base leading-relaxed" style={{ color: '#3CC8C2' }}>
