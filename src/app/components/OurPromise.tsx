  ...
  return (
    <motion.span
      ...
      style={{
        ...
        background: type === 'check' ? 'rgba(60,200,194,0.15)' : 'rgba(0,0,0,0.05)',
        color: type === 'check' ? TEAL : '#9CA3AF',
      }}
    >
      {type === 'check' ? '✓' : '✕'}
    </motion.span>
      ...
      <div className="relative max-w-7xl mx-auto px-8 lg:px-16 py-14 lg:py-20" style={{ zIndex: 1 }}>
        ...
        <motion.div
          ...
          style={{
            ...
            background: 'rgba(60,200,194,0.10)',
        ...
        <motion.p
          ...
          style={{ fontSize: 18, color: '#6B7280', lineHeight: 1.75, maxWidth: 600, marginBottom: 40 }}
        >
          We believe honest guidance builds confidence—and careers that endure.
        </motion.p>
        ...
        <div ref={cardsRef} className="grid md:grid-cols-2 gap-6 lg:gap-8 mb-10">
          ...
          <motion.div
            ...
            style={{
              background: 'rgba(60,200,194,0.06)',
