...
export function FinalCTA() {
  ...
  const inputStyle: React.CSSProperties = {
    ...
    borderBottom: '1px solid rgba(60,200,194,0.20)',
    color: '#111411',
    fontSize: '0.875rem',
    paddingTop: '0.75rem',
  ...
  return (
    <section className="relative overflow-hidden" style={{ borderTop: '1px solid rgba(147,112,219,0.10)' }}>
      {/* Top gradient border */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-8 lg:px-16 py-14 lg:py-20">
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          {/* Left: copy */}
          <AnimatedSection>
            <p className="text-[10px] tracking-[0.32em] uppercase font-medium mb-7" style={{ color: '#3CC8C2' }}>
              Start Your Journey
            </p>
            <h2 style={{ ...serif, fontSize: 'clamp(2.4rem,3.75vw,3.75rem)', lineHeight: 1.06, color: '#111411' }} className="mb-6">
              Begin With<br />
              <em style={serifItalic} className="text-[#3CC8C2]">Clarity</em>
            </h2>
            ...
            <div className="space-y-4 pt-6" style={{ borderTop: '1px solid rgba(60,200,194,0.10)' }}>
              {[
                ...
                >
                  <div className="w-1.5 h-1.5 rounded-full flex-shrink-0 mt-1.5" style={{ backgroundColor: '#3CC8C2' }} />
                  <div>
          ...
          <AnimatedSection delay={0.15}>
            <motion.div
              style={{
                ...
                borderRadius: 16,
                boxShadow: '0 8px 48px rgba(0,0,0,0.07), 0 2px 12px rgba(60,200,194,0.06)',
                padding: '2.5rem',
              }}
            >
              {submitted ? (
                ...
                >
                  <div className="w-12 h-12 rounded-full flex items-center justify-center mx-auto mb-6"
                       style={{ border: '1px solid rgba(60,200,194,0.35)' }}>
                    <svg width="16" height="12" viewBox="0 0 16 12" fill="none">
                      <path d="M1 6l5 5L15 1" stroke="#3CC8C2" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" />
                    </svg>
                  </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-0">
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      style={{
                        ...inputStyle,
                        borderBottomColor: errors.name ? 'rgba(220,38,38,0.5)' : 'rgba(60,200,194,0.20)',
                      }}
                      onFocus={e => (e.currentTarget.style.borderBottomColor = '#3CC8C2')}
                      onBlur={e => (e.currentTarget.style.borderBottomColor = errors.name ? 'rgba(220,38,38,0.5)' : 'rgba(60,200,194,0.20)')}
                  ...
                  <div className="mb-6">
                    ...
                    <input
                      ...
                      style={{
                        ...inputStyle,
                        borderBottomColor: errors.email ? 'rgba(220,38,38,0.5)' : 'rgba(60,200,194,0.20)',
                      }}
                      onFocus={e => (e.currentTarget.style.borderBottomColor = '#3CC8C2')}
                      onBlur={e => (e.currentTarget.style.borderBottomColor = errors.email ? 'rgba(220,38,38,0.5)' : 'rgba(60,200,194,0.20)')}
                      className="placeholder:text-[rgba(17,20,17,0.30)]"
                    />
                  ...
                  <div className="mb-10">
                    ...
                    <div className="relative">
                      <select
                        ...
                        style={{
                          ...inputStyle,
                          borderBottomColor: errors.program ? 'rgba(220,38,38,0.5)' : 'rgba(60,200,194,0.20)',
                          appearance: 'none',
                          cursor: 'pointer',
                      ...
                      <svg
                        ...
                        style={{ color: '#3CC8C2', opacity: 0.45 }}
